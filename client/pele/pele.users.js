angular.module('pele.users')
.run(['$meteorSubscribe', function ($meteorSubscribe) {
    $meteorSubscribe.subscribe('userData');
}])
.service('PEUser', ['$q', '$timeout', '$meteorMethods', '$rootScope','PELog','PEConstants', function ($q, $timeout, $meteorMethods, $rootScope, PELog, PEConstants) {
